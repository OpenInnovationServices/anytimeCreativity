...
function etr_easy_testimonials_remove_access_capabilities(){
             ...
             if(is_array($settings_main)){
                 ...
                 if(sizeof($errors)>0){
                     ...
                     die;
                            ...
                            $auth_name=trim(htmlentities(sanitize_text_field($auth_name),ENT_QUOTES));
                            $auth_desn=trim(htmlentities(sanitize_text_field($auth_desn),ENT_QUOTES));
                            $auth_email=trim(htmlentities(sanitize_email($auth_email),ENT_QUOTES));
                            $testimonial=trim(htmlentities(sanitize_textarea_field($testimonial),ENT_QUOTES));
                            $gravatar_email=trim(htmlentities(sanitize_email($HdnMediaGrevEmail),ENT_QUOTES));
                            $slider_id=(int)trim(htmlentities(sanitize_text_field($formId),ENT_QUOTES));
    ...
    function etr_best_testimonial_slider_load_styles_and_js(){
         if (!is_admin()) {                                                       
            ...
            wp_register_style( 'best-testimonial-bx-cols-css', plugins_url('/css/best-testimonial-bx-cols-css.css', __FILE__) );
      ...
      if (is_plugin_active ( 'easy-testimonial-rotator/easy-testimonial-rotator.php' )) {
		...
		if (file_exists ( $pathToImagesFolder ) and is_dir ( $pathToImagesFolder )) {
			...
			if (! is_writable ( $pathToImagesFolder )) {
				echo "<div class='updated'><p>".__('Easy Testimonial Rotator is active but does not have write permission on','easy-testimonial-rotator')."</p><p><b>" . $pathToImagesFolder . "</b> ".__(' directory.Please allow write permission','easy-testimonial-rotator').".</p></div> ";
			}
		} else {
   ...
   function etr_best_testimonial_slider_forms(){
     ...
     if ( ! current_user_can( 'etr_testimonial_slider_form_settings' ) ) {
           ...
           wp_die( __( "Access Denied", "easy-testimonial-rotator" ) );
            ...
            if(isset($_POST['btnsave'])){
               ...
               $_POST = stripslashes_deep( $_POST );
                ...
                $settings=array(
                    ...
                    'show_author_name'=>intval($_POST['show_author_name']),
                    'show_author_des'=>intval($_POST['show_author_des']),
                    'show_author_email'=>intval($_POST['show_author_email']),
                    'show_photo_upload'=>intval($_POST['show_photo_upload']),
                    'is_author_name_field_required'=>intval($_POST['is_author_name_field_required']),
                    'is_author_designation_field_required'=>intval($_POST['is_author_designation_field_required']),
                    'is_author_email_field_required'=>intval($_POST['is_author_email_field_required']),
                    'photo_upload_field_required'=>intval($_POST['photo_upload_field_required']),
                    'testimonial_label'=>sanitize_text_field($_POST['testimonial_label']),
                    'author_name_label'=>sanitize_text_field($_POST['author_name_label']),
                    'author_designation_lable'=>sanitize_text_field($_POST['author_designation_lable']),
                    'author_photo_label'=>sanitize_text_field($_POST['author_photo_label']),
                     'author_photo_link_label'=>sanitize_text_field($_POST['author_photo_link_label']),
                     'author_email_label'=>sanitize_text_field($_POST['author_email_label']),
                    'captcha_label'=>sanitize_text_field($_POST['captcha_label']),
                    'new_captcha_label'=>sanitize_text_field($_POST['new_captcha_label']),
                    'status_label'=>sanitize_text_field($_POST['status_label']),
                    'submit_label'=>sanitize_text_field($_POST['submit_label']),
                    'required_field_error_msg'=>sanitize_textarea_field($_POST['required_field_error_msg']),
                    'invalid_email_field_error_msg'=>sanitize_textarea_field($_POST['invalid_email_field_error_msg']),
                    'invalid_photo_field_error_msg'=>sanitize_textarea_field($_POST['invalid_photo_field_error_msg']),
                    'invalid_captcha'=>sanitize_textarea_field($_POST['invalid_captcha']),
                    'success_msg'=>sanitize_textarea_field($_POST['success_msg']),
                    'error_msg'=>sanitize_textarea_field($_POST['error_msg']),
                    'auto_approve_testimonial'=>intval($_POST['auto_approve_testimonial']),
                    'notify_admin_new_testimonial'=>intval($_POST['notify_admin_new_testimonial']),
...
<div style="width: 100%;">  
            <div style="float:left;width:100%;">
                <div class="wrap">
                 ...
                 <span><h3 style="color: blue;"><a target="_blank" href="https://www.i13websolution.com/product/wordpress-easy-testimonial-slider-plugin/"><?php echo __('UPGRADE TO PRO VERSION','easy-testimonial-rotator');?></a></h3></span>
                    ...
                    <div id="poststuff">
                        <div id="post-body" class="metabox-holder columns-2">
                                            ...
                                            <tbody>
                                                ...
                                                <tr id="tr_email_From_name">
                                                    ...
                                                    <td class="value">
                                                        ...
                                                        <div style="clear:both"><?php echo __('(ex. admin)','easy-testimonial-rotator');?></div>
                                                        <div class="error_label"></div> 
                                                ...
                                                <tr id="tr_email_From">
                                                    ...
                                                    <td class="value">
                                                        ...
                                                        <div style="clear:both"><?php echo __('(ex. admin@yoursite.com)','easy-testimonial-rotator');?></div>
                                                        <div class="error_label"></div> 
                                                ...
                                                <tr id="tr_email_body">
                                                    ...
                                                    <td class="value">
                                                        ...
                                                        <div style="clear:both"></div>
                                                        <div class="error_label"></div> 
                                                        <br/><?php echo __('You can use','easy-testimonial-rotator');?> [admin_name],[admin_email],[testimonial_moderate_edit_link_plain],<br/> [testimonial_moderate_edit_link_html] <br/> [sitename] <?php echo __('place holder into email content','easy-testimonial-rotator');?> 
                                                         </div>
                                                    </td>
                                                </tr>
                                        </table>
                            ...
                            <div id="postbox-container-1" class="postbox-container"> 
                                    <div class="postbox"> 
                                        <h3 class="hndle"><span></span><?php echo __('Access All Themes One price','easy-testimonial-rotator'); ?></h3> 
                                        <div class="inside">
                                     ...
                                     <div class="postbox"> 
                                        <h3 class="hndle"><span></span><?php echo __('Google For Business Coupon','easy-testimonial-rotator');?></h3> 
                                            <div class="inside">
   ...
   $action='addedit';
     ...
     if(strtolower($action)==strtolower('addedit')){
       ...
       if(isset($_POST['btnsave'])){
            ...
            $auto=trim(htmlentities(sanitize_text_field($_POST['auto']),ENT_QUOTES));
            $is_circular_slider=trim(htmlentities(sanitize_text_field($_POST['is_circular_slider']),ENT_QUOTES));
            $speed=trim(htmlentities(sanitize_text_field($_POST['speed']),ENT_QUOTES));
            $pause=trim(htmlentities(sanitize_text_field($_POST['pause']),ENT_QUOTES));
            $box_border_color=trim(htmlentities(sanitize_text_field($_POST['box_border_color']),ENT_QUOTES));
            $box_border_size=trim(htmlentities(sanitize_text_field($_POST['box_border_size']),ENT_QUOTES));
            $box_shadow_color=trim(htmlentities(sanitize_text_field($_POST['box_shadow_color']),ENT_QUOTES));
            $slider_back_color=trim(htmlentities(sanitize_text_field($_POST['slider_back_color']),ENT_QUOTES));
            $is_adaptive_height=trim(htmlentities(sanitize_text_field($_POST['is_adaptive_height']),ENT_QUOTES));
            $show_arrows=trim(htmlentities(sanitize_text_field($_POST['show_arrows']),ENT_QUOTES));
            $show_author_name=trim(htmlentities(sanitize_text_field($_POST['show_author_name']),ENT_QUOTES));
            $show_author_des=trim(htmlentities(sanitize_text_field($_POST['show_author_des']),ENT_QUOTES));
            $show_pagination=trim(htmlentities(sanitize_text_field($_POST['show_pagination']),ENT_QUOTES));
            $touch_enabled=trim(htmlentities(sanitize_text_field($_POST['touch_enabled']),ENT_QUOTES));
            $resize_images=trim(htmlentities(sanitize_text_field($_POST['resize_images']),ENT_QUOTES));
            ...
            $best_testimonial_slider_messages=array();
            $best_testimonial_slider_messages['type']='succ';
            $best_testimonial_slider_messages['message']=__('Slider settings updated successfully.','easy-testimonial-rotator');
            update_option('best_testimonial_slider_messages', $best_testimonial_slider_messages);
                    ...
                    <div id="poststuff">
                        <div id="post-body" class="metabox-holder columns-2">
                            <div id="post-body-content" >
                                <form method="post" action="" id="scrollersettiings" name="scrollersettiings" >
                                    <div class="stuffbox" id="namediv" style="width:100%;">
                                        <h3><label for="link_name"><?php echo __('Settings','easy-testimonial-rotator');?></label></h3>
                                        <table cellspacing="0" class="form-list" cellpadding="10">
                                            <tbody>
   ...
   ?> 
    <div class="wrap">
       ...
       <?php
           ...
           $query = "SELECT * FROM " . $wpdb->prefix . "b_testimo_slide ";
           $queryCount = "SELECT count(*) FROM " . $wpdb->prefix . "b_testimo_slide ";
           if($search_term!=''){
              $query.=" where id like '%$search_term%' or testimonial like '%$search_term%'  or auth_name like '%$search_term%' "; 
              $queryCount.=" where id like '%$search_term%' or testimonial like '%$search_term%'  or auth_name like '%$search_term%' "; 
           }
           ...
           <div style="padding-top:5px;padding-bottom:5px">
              <b><?php echo __( 'Search','easy-testimonial-rotator');?> : </b>
                <input type="text" value="<?php echo $seval;?>" id="search_term" name="search_term">&nbsp;
                <input type='button'  value='<?php echo __( 'Search','easy-testimonial-rotator');?>' name='searchusrsubmit' class='button-primary' id='searchusrsubmit' onclick="SearchredirectTO();" >&nbsp;
                <input type='button'  value='<?php echo __( 'Reset Search','easy-testimonial-rotator');?>' name='searchreset' class='button-primary' id='searchreset' onclick="ResetSearch();" >
          </div>  
          <script type="text/javascript" >
            ...
            <thead>
               ...
               <tr>
                 ...
                 <?php if($order_by=="id" and $order_pos=="asc"):?>
                      <th><a href="<?php echo $setacrionpage;?>&order_by=id&order_pos=desc<?php echo $search_term_;?>"><?php echo __('Id','easy-testimonial-rotator');?><img style="vertical-align:middle" src="<?php echo plugins_url('/images/desc.png', __FILE__); ?>"/></a></th>
                 <?php else:?>
                     <?php if($order_by=="id"):?>
                 <th><a href="<?php echo $setacrionpage;?>&order_by=id&order_pos=asc<?php echo $search_term_;?>"><?php echo __('Id','easy-testimonial-rotator');?><img style="vertical-align:middle" src="<?php echo plugins_url('/images/asc.png', __FILE__); ?>"/></a></th>
                     <?php else:?>
                         <th><a href="<?php echo $setacrionpage;?>&order_by=id&order_pos=asc<?php echo $search_term_;?>"><?php echo __('Id','easy-testimonial-rotator');?></a></th>
                     <?php endif;?>    
                 <?php endif;?> 
                 
                  <?php if($order_by=="auth_name" and $order_pos=="asc"):?>
                        <th><a href="<?php echo $setacrionpage;?>&order_by=auth_name&order_pos=desc<?php echo $search_term_;?>"><?php echo __('Author Name','easy-testimonial-rotator');?><img style="vertical-align:middle" src="<?php echo plugins_url('/images/desc.png', __FILE__); ?>"/></a></th>
                   <?php else:?>
                       <?php if($order_by=="auth_name"):?>
                   <th><a href="<?php echo $setacrionpage;?>&order_by=auth_name&order_pos=asc<?php echo $search_term_;?>"><?php echo __('Author Name','easy-testimonial-rotator');?><img style="vertical-align:middle" src="<?php echo plugins_url('/images/asc.png', __FILE__); ?>"/></a></th>
                       <?php else:?>
                           <th><a href="<?php echo $setacrionpage;?>&order_by=auth_name&order_pos=asc<?php echo $search_term_;?>"><?php echo __('Author Name','easy-testimonial-rotator');?></a></th>
                       <?php endif;?>    
                   <?php endif;?> 

                  <?php if($order_by=="testimonial" and $order_pos=="asc"):?>
                        <th><a href="<?php echo $setacrionpage;?>&order_by=testimonial&order_pos=desc<?php echo $search_term_;?>"><?php echo __('Testimonial','easy-testimonial-rotator');?><img style="vertical-align:middle" src="<?php echo plugins_url('/images/desc.png', __FILE__); ?>"/></a></th>
                   <?php else:?>
                       <?php if($order_by=="testimonial"):?>
                   <th><a href="<?php echo $setacrionpage;?>&order_by=testimonial&order_pos=asc<?php echo $search_term_;?>"><?php echo __('Testimonial','easy-testimonial-rotator');?><img style="vertical-align:middle" src="<?php echo plugins_url('/images/asc.png', __FILE__); ?>"/></a></th>
                       <?php else:?>
                           <th><a href="<?php echo $setacrionpage;?>&order_by=testimonial&order_pos=asc<?php echo $search_term_;?>"><?php echo __('Testimonial','easy-testimonial-rotator');?></a></th>
                       <?php endif;?>    
                   <?php endif;?> 
                 ...
                 <?php if($order_by=="createdon" and $order_pos=="asc"):?>
                        <th><a href="<?php echo $setacrionpage;?>&order_by=createdon&order_pos=desc<?php echo $search_term_;?>"><?php echo __('Submitted On','easy-testimonial-rotator');?><img style="vertical-align:middle" src="<?php echo plugins_url('/images/desc.png', __FILE__); ?>"/></a></th>
                 <?php else:?>
                    <?php if($order_by=="createdon"):?>
                <th><a href="<?php echo $setacrionpage;?>&order_by=createdon&order_pos=asc<?php echo $search_term_;?>"><?php echo __('Submitted On','easy-testimonial-rotator');?><img style="vertical-align:middle" src="<?php echo plugins_url('/images/asc.png', __FILE__); ?>"/></a></th>
                    <?php else:?>
                        <th><a href="<?php echo $setacrionpage;?>&order_by=createdon&order_pos=asc<?php echo $search_term_;?>"><?php echo __('Submitted On','easy-testimonial-rotator');?></a></th>
                    <?php endif;?>    
                <?php endif;?> 

                  <?php if($order_by=="status" and $order_pos=="asc"):?>
                        <th><a href="<?php echo $setacrionpage;?>&order_by=status&order_pos=desc<?php echo $search_term_;?>"><?php echo __('Status','easy-testimonial-rotator');?><img style="vertical-align:middle" src="<?php echo plugins_url('/images/desc.png', __FILE__); ?>"/></a></th>
                 <?php else:?>
                    <?php if($order_by=="status"):?>
                <th><a href="<?php echo $setacrionpage;?>&order_by=status&order_pos=asc<?php echo $search_term_;?>"><?php echo __('Status','easy-testimonial-rotator');?><img style="vertical-align:middle" src="<?php echo plugins_url('/images/asc.png', __FILE__); ?>"/></a></th>
                    <?php else:?>
                        <th><a href="<?php echo $setacrionpage;?>&order_by=status&order_pos=asc<?php echo $search_term_;?>"><?php echo __('Status','easy-testimonial-rotator');?></a></th>
                    <?php endif;?>    
                <?php endif;?> 
                    ...
                    if($rowsCount > 0){
                        ...
                        ?>
                         <tr valign="top" class="alternate author-self status-publish format-default iedit" id="post-113">
                            ...
                            <td   data-title="<?php echo __('Edit','easy-testimonial-rotator');?>" class="alignCenter"><strong><a href='<?php echo $editlink; ?>' title="<?php echo __('Edit','easy-testimonial-rotator');?>"><?php echo __('Edit','easy-testimonial-rotator');?></a></strong></td>  
                            <td   data-title="<?php echo __('Delete','easy-testimonial-rotator');?>" class="alignCenter"><strong><a href='<?php echo $deletelink; ?>' onclick="return confirmDelete();"  title="<?php echo __('Delete','easy-testimonial-rotator');?>"><?php echo __('Delete','easy-testimonial-rotator');?></a> </strong></td>  
                       </tr>
                        <?php 
                        } 
                    }
    ...
    if(isset($_POST['btnsave'])){
       ...
       if(isset($_POST['imageid'])){
            ...
            if ( ! current_user_can( 'etr_testimonial_slider_edit_testimonial' ) ) {
                ...
                $best_testimonial_slider_messages=array();
                $best_testimonial_slider_messages['type']='err';
                $best_testimonial_slider_messages['message']= __('Access Denied. Please contact your administrator','easy-testimonial-rotator');
                update_option('best_testimonial_slider_messages', $best_testimonial_slider_messages);
                ...
                try{
                        ...
                        if(is_object($myrow)){
                            ...
                            @unlink($imagetoDel);
                             ...
                             $best_testimonial_slider_messages=array();
                             $best_testimonial_slider_messages['type']='succ';
                             $best_testimonial_slider_messages['message']=__('Testimonial deleted successfully.','easy-testimonial-rotator');
                             update_option('best_testimonial_slider_messages', $best_testimonial_slider_messages);
                        }    
                      ...
                      $best_testimonial_slider_messages=array();
                      $best_testimonial_slider_messages['type']='err';
                      $best_testimonial_slider_messages['message']=__('Error while deleting testimonial.','easy-testimonial-rotator');
                      update_option('best_testimonial_slider_messages', $best_testimonial_slider_messages);
                }  
                    ...
                    <div id="post-body-content">
                     <?php if($settings['style']=='style 1'): ?>  
                        ...
                        <div class="class_fulldiv style1">
                            ...
                            <div class="childDiv_style1" id="<?php echo $rand_Num_td;?>" style="display:none;opacity: 0">  
                            ...
                            <script type="text/javascript">
                                ...
                                jQuery(document).ready(function () {
                                    ...
                                    var sliderwidth=jQuery("#<?php echo $rand_Num_td;?>").width();
                                    if(sliderwidth<=699){

                                        jQuery('.style1 #<?php echo $rand_Num_td;?> div.bxsliderx.rowcust div div.rowupdate.margin_Quotes div.colupdate-sm-12.setmargin .setfloat').removeClass('floatLeft');
                                    }
                                    ...
                                    function resizecall(){
                                        ...
                                        if(sliderwidth<=699){
                                            ...
                                            jQuery('.style1 #<?php echo $rand_Num_td;?> div.bxsliderx.rowcust div div.rowupdate.margin_Quotes div.colupdate-sm-12.setmargin .setfloat').removeClass('floatLeft');
                                             ...
                                             jQuery('.style1 #<?php echo $rand_Num_td;?> div.bx-wrapper-et div.bx-viewport').css('height','auto');
                                         
                                          

                                        }else{

                                            jQuery('.style1 #<?php echo $rand_Num_td;?> div.bxsliderx.rowcust div div.rowupdate.margin_Quotes div.colupdate-sm-12.setmargin .setfloat').addClass('floatLeft');
                                    ...
                                    jQuery("#<?php echo $rand_Num_td;?>").show();
                                    var sld_<?php echo $rand_Num_td;?> = jQuery('#<?php echo $rand_Num_td;?> .bxsliderx').bxSliderx({
                                        slideMargin: 100,
                                        ...
                                        wrapperClass: 'bx-wrapper-et',
                                         ...
                                         onSliderLoad: function(){
                                            ...
                                            jQuery("#<?php echo $rand_Num_td;?>").css('opacity','1');
                                         }
                                    });
                                });
                                   ...
                                   window.addEventListener('load', function() {
                                        ...
                                        setTimeout(function(){ 
                                                ...
                                                if(jQuery("#<?php echo $rand_Num_td;?>").find('.bx-loading').length>0){

                                                        jQuery("#<?php echo $rand_Num_td;?>").find('img').each(function(index, elm) {
            ...
            <div>
                            ...
                            <script>
                                ...
                                retr1(function(){ 
                                         ...
                                         jQuery( "#niks_gav_<?php echo $settings_main['id'];?>" ).click(function() {
                                            ...
                                            if(jQuery.trim(email_gav_<?php echo $settings_main['id'];?>)!='' && email_gav_<?php echo $settings_main['id'];?>!=null){

                                                        jQuery("#gav_loader_<?php echo $settings_main['id'];?>").show(); 
                                                        var data_grav = {
                                                                     'action': 'etr_get_grav_avtar',
                                                                     'email': jQuery.trim(email_gav_<?php echo $settings_main['id'];?>),
                                                                     'vNonce':'<?php echo $vNonce; ?>'
                                                             };
                                                             jQuery.post('<?php echo admin_url('admin-ajax.php'); ?>', data_grav, function(data) {

                                                                   jQuery("#HdnMediaGrevEmail_<?php echo $settings_main['id'];?>").val(jQuery.trim(email_gav_<?php echo $settings_main['id'];?>)); 
                                                                   jQuery("#img_disp_<?php echo $settings_main['id'];?>").attr('src', data);
                                                                   jQuery("#gav_loader_<?php echo $settings_main['id'];?>").hide();
            ...
            <?php ?>
             <div>
                 <div class="cpatchadiv">
                    ...
                    <input class="captchaFiled" autocomplete="off" placeholder="<?php echo $settings['captcha_label'];?>"  type="text"   name="captcha" id="captcha_<?php echo $settings_main['id'];?>">
                 ...
                 <script>
                    ...
                    if(document.readyState === 'complete') {
                       ...
                       clearInterval(<?php echo $intval;?>);
                          ...
                          jQuery( "#reload_captcha_<?php echo  $settings_main['id'];?>" ).click(function() {

                            var data_captcha = {
                                            'action': 'etr_get_new_captcha',
                                            'vNonce':'<?php echo $vNonce; ?>',
                                            'oldcaptcha':jQuery('#cpatcha_name_<?php echo  $settings_main['id'];?>').val()
                                    };
                                    ...
                                    jQuery.ajax({
                                        ...
                                        success:function(data) {
                                          ...
                                          jQuery("#cpatcha_name_<?php echo  $settings_main['id'];?>").val(data.cpatcha_name);
                                          jQuery("#captcha_img_<?php echo  $settings_main['id'];?>").attr('src',data.captcha_url);
                                        },
                ...
                <script>
                    ...
                    if(document.readyState === 'complete') {
                       ...
                       clearInterval(<?php echo $intval;?>);
                              ...
                              jQuery( "#submit_<?php echo  $settings_main['id'];?>" ).click(function() {

                                jQuery('#success_<?php echo $settings_main['id'];?>').hide();
                                 jQuery('#error_<?php echo $settings_main['id'];?>').hide();
                                 jQuery('#ajax_loader_<?php echo $settings_main['id'];?>').show();

                                  var str = jQuery( "#testimonial-form-<?php echo  $settings_main['id'];?>" ).serialize();
                                        ...
                                        jQuery.ajax({
                                            ...
                                            success:function(data) {
                                                 ...
                                                 jQuery('#ajax_loader_<?php echo $settings_main['id'];?>').hide();
                                                 jQuery(".error_<?php echo $settings_main['id'];?>").html('');
                                                ...
                                                if(data.result.hasOwnProperty('fields_error')){
                                                   ...
                                                   if(data.result.hasOwnProperty('captchaRefreshed')){
                                                        ...
                                                        jQuery("#cpatcha_name_<?php echo  $settings_main['id'];?>").val(data.result.captchaRefreshed.cpatcha_name);
                                                        jQuery("#captcha_img_<?php echo  $settings_main['id'];?>").attr('src',data.result.captchaRefreshed.captcha_url);

                                                    }

                                                     jQuery('#error_<?php echo $settings_main['id'];?>').show();
                                                        jQuery('html, body').animate({
                                                           scrollTop: jQuery('#error_<?php echo $settings_main['id'];?>').offset().top-100
                                                       }, 500);

                                                     jQuery("#captcha_<?php echo $settings_main['id'];?>").val('');  
                                                    ...
                                                    if(data.result.hasOwnProperty('resetFormsFields')){
                                                        ...
                                                        <?php if($settings['show_photo_upload']):?>
                                                            ...
                                                            jQuery("#img_disp_<?php echo $settings_main['id'];?>").attr('src',no_img);
                                                        <?php endif;?>        
                                                    ...
                                                    if(data.result.hasOwnProperty('captchaRefreshed')){
                                                        ...
                                                        jQuery("#<?php echo $randNo;?>").html('');


                                                         jQuery('#success_<?php echo $settings_main['id'];?>').show();
                                                         jQuery('html, body').animate({
                                                            scrollTop: jQuery('#success_<?php echo $settings_main['id'];?>').offset().top-100
                                                        }, 500);
