			...
			<table class='rich_web_SaveSl_Table' style='float:left;'>
				...
				<tr>
					<td style='width:100%;text-align:center;' colspan='2'>
						...
						<div class="RW_IS_Med_But" onclick="rich_web_Video_Src_Clicked()" style="border: 1px solid rgba(0, 73, 107, 0.8);color: rgba(0, 73, 107, 0.8);background-color: #f4f4f4;padding: 5px;width: 66px;border-radius: 6%; cursor:pointer;">
							<span class="RW_IS_Med_But_Inner">Add Video</span>
						</div>
					</td>
				</tr>
				<tr>
